...
const EXTENSION_PERIOD_RANGE: Range = STEPS_PER_SECOND / 4..=STEPS_PER_SECOND / 2;
const EXTENSION_SLEEP_PERIOD_RANGE: Range = 0..=STEPS_PER_SECOND / 2;
const EXTENSION_RETURN_PERIOD_RANGE: Range = STEPS_PER_SECOND / 2..=STEPS_PER_SECOND / 2;
const EXTENSION_RETURN_SLEEP_PERIOD_RANGE: Range = 0..=STEPS_PER_SECOND / 2;

const CONTRACTION_PERIOD_RANGE: Range = STEPS_PER_SECOND / 4..=STEPS_PER_SECOND / 2;
const CONTRACTION_SLEEP_PERIOD_RANGE: Range = 0..=STEPS_PER_SECOND / 2;
const CONTRACTION_RETURN_PERIOD_RANGE: Range = STEPS_PER_SECOND / 4..=STEPS_PER_SECOND / 2;
const CONTRACTION_RETURN_SLEEP_PERIOD_RANGE: Range = 0..=STEPS_PER_SECOND / 2;
